        ...
        <Navbar bg="dark" expand="lg" variant="dark" className="px-3">
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    <Badge className="mt-2" bg="primary" style={{ marginRight: "1rem" }}>
                        Products In stock {products.data.length}
                    </Badge>
                </Nav>
                <Form onSubmit={filterProduct} className="d-flex ms-auto" style={{ alignItems: "center" }}>
                    <Link to="/addproduct" className="btn btn-primary btn-sm mr-2" style={{ marginRight: "1rem" }}>
                        Add Product
                    </Link>
                    <Link to="/addsupplier" className="btn btn-secondary btn-sm mr-2" style={{ marginRight: "1rem" }}>
                        Add Supplier
                    </Link>
                    <FormControl
                        value={search}
